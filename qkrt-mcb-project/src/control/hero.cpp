    ...
    : m_drivers(drivers),
      ...
      m_turret(drivers,
                turret::TurretConfig {
                    ...
                    .pitchHorizontalOffset = 0.0f,      
                    .pitchUpLim = 0.0f,                  
                    .pitchDownLim = 0.0f,               
                    .MAX_PITCH_POWER = M3508::MAX_CURRENT,
                    .MAX_YAW_POWER = M3508::MAX_CURRENT,
                    .MAX_RPS = GM6020::MAX_RPS,
                    .pitchPosGains = { .kp = 4.0f, .ki = 0.0f, .kd = 0.0f, .maxICumulative = 500.0f, .maxOutput = GM6020::MAX_VOLTAGE },
                    .pitchVelGains = { .kp = 1000.0f, .ki = 110.0f, .kd = 0.0f, .maxICumulative = 3000.0f, .maxOutput = GM6020::MAX_VOLTAGE },
